...
<table>
  <tr>
   ...
   <tr>
    <td>Анализ результатов рекламной компании и выяснение причин падения аудитории <a href="https://github.com/MariaKln/marketplace_analisys_pc" target="_blank">(github)</a></td>
