...
### Обо мне:
Я начинающий BI аналитик с математическим образованием. Работаю в IT с 2011 года.

Мой путь в аналитику начался из проджект-менеджмента, и это моё преимущество: я не просто считаю метрики, а понимаю, **зачем** бизнесу нужны эти цифры и как их нужно приподнести.
...
<table>
  ...
  <tr>
    ...
    <td>Выяснить, от чего зависит цена, а также популярность персональных компьютеров, выкладываемых на онлайн-площадках, чтобы в дальнейшем планировать к сборке востребованные по техническим характеристикам компьютеры и продавать их по конкурентной цене.</td>
